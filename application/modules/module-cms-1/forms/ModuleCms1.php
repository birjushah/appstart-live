<?php 
class ModuleCms1_Form_ModuleCms1 extends Standard_Form{
	public function init(){
		...
		//  Cms ID
		$module_cms_id = $this->createElement ( "hidden", "module_cms_1_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim'
				)
		...
		//  Cms Detail Id
		$module_cms_detail_id = $this->createElement ( "hidden", "module_cms_detail_1_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim'
				)
