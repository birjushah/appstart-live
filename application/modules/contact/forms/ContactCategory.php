<?php
class Contact_Form_ContactCategory extends Standard_Form {
	public function init() {
		...
		// Contact Detail ID
		$contact_category_detail_id = $this->createElement ( "hidden", "contact_category_detail_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim'
				)
		) );
		$this->addElement ( $contact_category_detail_id );
