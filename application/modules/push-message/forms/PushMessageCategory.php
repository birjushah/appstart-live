<?php
class PushMessage_Form_PushMessageCategory extends Standard_Form {
	public function init() {
		...
		// Module Events ID
		$module_push_message_id = $this->createElement ( "hidden", "push_message_category_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim' 
				) 
		) );
		$this->addElement ( $module_push_message_id);
		
		// Module Events Detail ID
		$module_push_message_detail_id = $this->createElement ( "hidden", "push_message_category_detail_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim'
				)
		) );
		$this->addElement ( $module_push_message_detail_id);
