<?php
class Website_Form_Website extends Standard_Form {
	public function init() {
		...
		// Website Id
		$module_website_id = $this->createElement ( "hidden", "module_website_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim' 
				) 
		...
		// Website Detail Id
		$module_website_detail_id = $this->createElement ( "hidden", "module_website_detail_id", array (
				'value' => '',
				'filters' => array (
						'StringTrim' 
				) 
