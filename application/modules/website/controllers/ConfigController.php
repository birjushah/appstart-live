<?php
class Website_ConfigController extends Zend_Controller_Action {
	...
	public function installAction() {
		...
		try {
			...
			// Create Table Website If Not Exsist
			$sql = "CREATE TABLE IF NOT EXISTS `module_website` (
			...
			// Create Table Website detail If Not Exsist
			$sql = "CREATE TABLE IF NOT EXISTS `module_website_detail` (
