 ...
 *
 * @category  Services
 * @package   Standard_Plugin_Music_Soundcloud
 * @author    Anton Lindqvist <anton@qvister.se>
 * @copyright 2010 Anton Lindqvist <anton@qvister.se>
 * @license   http://www.opensource.org/licenses/mit-license.php MIT
 * @link      http://github.com/mptre/php-soundcloud
 */
class Standard_Plugin_Music_Soundcloud
{
     ...
     *
     * @return void
     * @throws Standard_Plugin_Music_Soundcloud_Missing_Client_Id_Exception
     *
     * @access public
     */
     ...
     *
     * @return string
     * @throws Standard_Plugin_Music_Soundcloud_Unsupported_Audio_Format_Exception
     *
     * @access public
     */
    function getAudioMimeType($extension)
    {
        if (array_key_exists($extension, self::$_audioMimeTypes)) {
            ...
            throw new Standard_Plugin_Music_Soundcloud_Unsupported_Audio_Format_Exception();
        }
    }
     ...
     *
     * @return object
     * @throws Standard_Plugin_Music_Soundcloud_Unsupported_Response_Format_Exception
     *
     * @access public
     */
    function setResponseFormat($format)
    {
        if (array_key_exists($format, self::$_responseFormats)) {
            ...
            throw new Standard_Plugin_Music_Soundcloud_Unsupported_Response_Format_Exception();
        }
    ...
    function get($path, $params = array(), $curlOptions = array())
    {
        ...
        $array = json_decode(Zend_Json::fromXml($content));
    ...
    {
        return self::$_userAgent . '/' . new Standard_Plugin_Music_Soundcloud_Version;
    }
     ...
     *
     * @return mixed
     * @throws Standard_Plugin_Music_Soundcloud_Invalid_Http_Response_Code_Exception
     *
     * @access protected
     */
    protected function _request($url, $curlOptions = array())
    {
        ...
        //$options[CURLOPT_CAINFO] = __DIR__ . "/Soundcloud/cacert.pem";
        ...
        if ($this->_validResponseCode($this->_lastHttpResponseCode)) {
            ...
            throw new Standard_Plugin_Music_Soundcloud_Invalid_Http_Response_Code_Exception(
                null,
                0,
