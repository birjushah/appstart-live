<?php 
	session_start();
	$customer_id = $_SESSION["Zend_Auth"]["storage"]->customer_id;
	$basePath =  "/appstart/public/resource/default/uploads/C".$customer_id;
	if(!is_dir($_SERVER["DOCUMENT_ROOT"] . $basePath))
		mkdir($_SERVER["DOCUMENT_ROOT"] . $basePath,0777);
?>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var base = "<?php echo $basePath;?>"; /*Relative to Root*/
