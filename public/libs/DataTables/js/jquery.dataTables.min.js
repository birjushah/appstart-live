...
(function(i, O, l, n) {
	var j = function(e) {
		...
		function r(a, b, c) {
			...
			var h = d.mRender ? S(d.mRender) : null,
				f = S(d.mData);
			d.fnGetData = function(a, b) {
				var c = f(a, b);
				return d.mRender && b && "" !== b ? h(c, b, a) : c
			};
			d.fnSetData = ta(d.mData);
		...
		function ua(a, b, c, d) {
			...
			if (b) for (h = b.length - 1; 0 <= h; h--) {
				...
				for (g = m.length; f < g; f++) if ("number" === typeof m[f] && 0 <= m[f]) {
					...
					d(m[f], b[h])
				} else if ("number" === typeof m[f] && 0 > m[f]) d(a.aoColumns.length + m[f], b[h]);
		...
		function va(a) {
			...
			for (c = e.length; b < c; b++) {
				d = 0;
				for (h = e[b].childNodes.length; d < h; d++) f = e[b].childNodes[d], m = f.nodeName.toUpperCase(), ("TD" == m || "TH" == m) && g.push(f)
			}
			h = 0;
			for (e = a.aoColumns.length; h < e; h++) {
				...
				if (f || s || o || !k) {
					b = 0;
					for (c = a.aoData.length; b < c; b++) d = a.aoData[b], r = g[b * e + h], f && "string" != m.sType && (n = x(a, b, h, "type"), "" !== n && (n = D(n), null === m.sType ? m.sType = n : m.sType != n && "html" != m.sType && (m.sType = "string"))), "function" === typeof m.mData && (r.innerHTML = x(a, b, h, "display")), s && (n = T(a, b, h), r.innerHTML = n, m.bUseRendered && I(a, b, h, n)), o && (r.className += " " + m.sClass), k ? d._anHidden[h] = null : (d._anHidden[h] = r, r.parentNode.removeChild(r)), m.fnCreatedCell && m.fnCreatedCell.call(a.oInstance, r, x(a, b, h, "display"), d._aData, b, h)
				}
			}
		...
		function wa(a) {
			...
			if (0 !== a.nTHead.getElementsByTagName("th").length) {
				...
				b = 0;
				for (d = a.aoColumns.length; b < d; b++) c = a.aoColumns[b].nTh, c.innerHTML = a.aoColumns[b].sTitle, c.setAttribute("tabindex", "0"), null !== a.aoColumns[b].sClass && i(c).addClass(a.aoColumns[b].sClass), h.appendChild(c);
			...
			if (a.oFeatures.bSort) for (b = 0; b < a.aoColumns.length; b++)!1 !== a.aoColumns[b].bSortable ? ha(a, a.aoColumns[b].nTh, b) : i(a.aoColumns[b].nTh).addClass(a.oClasses.sSortableNone);
		...
		function ya(a) {
			...
			for (var c = a.nTableWrapper, d = a.sDom.split(""), h, f, g, e, s, m, o, k = 0; k < d.length; k++) {
				...
				else if ("l" == g && a.oFeatures.bPaginate && a.oFeatures.bLengthChange) h = za(a), f = 1;
				else if ("f" == g && a.oFeatures.bFilter) h = Aa(a), f = 1;
				else if ("r" == g && a.oFeatures.bProcessing) h = Ba(a), f = 1;
				else if ("t" == g) h = Ca(a), f = 1;
				else if ("i" == g && a.oFeatures.bInfo) h = Da(a), f = 1;
				else if ("p" == g && a.oFeatures.bPaginate) h = Ea(a), f = 1;
		...
		function W(a, b) {
			...
			for (s = c.length; h < s; h++) {
				...
				for (m = c[h].childNodes.length; f < m; f++) if (d = c[h].childNodes[f], "TD" == d.nodeName.toUpperCase() || "TH" == d.nodeName.toUpperCase()) {
					...
					for (g = 0; a[h][g];) g++;
					j = g;
					for (e = 0; e < o; e++) for (g = 0; g < k; g++) a[h + g][j + e] = {
						cell: d,
						unique: 1 == o ? !0 : !1
					}, a[h + g].nTr = c[h]
				}
		...
		function P(a, b, c) {
			...
			for (var b = 0, h = c.length; b < h; b++) for (var f = 0, g = c[b].length; f < g; f++) if (c[b][f].unique && (!d[f] || !a.bSortCellsTop)) d[f] = c[b][f].cell;
			return d
		}
		function xa(a) {
			if (a.bAjaxDataGet) {
		...
		function Ca(a) {
			...
			a.oScroll.bInfinite && i(h).scroll(function() {
		...
		function Ma(a) {
			var b = a.nScrollHead.getElementsByTagName("div")[0],
				...
				p = null !== a.nTFoot ? n.getElementsByTagName("table")[0] : null,
				l = a.oBrowser.bScrollOversize;
			...
			} else "" !== a.oScroll.sXInner ? a.nTable.style.width = q(a.oScroll.sXInner) : h == i(d).width() && i(d).height() < i(a.nTable).height() ? (a.nTable.style.width = q(h - a.oScroll.iBarWidth), i(a.nTable).outerWidth() > h - a.oScroll.iBarWidth && (a.nTable.style.width = q(h))) : a.nTable.style.width = q(h);
			h = i(a.nTable).outerWidth();
			...
			} else d.style.width = q("100%"), b.parentNode.style.width = q("100%"), null !== a.nTFoot && (n.parentNode.style.width = q("100%"));
		...
		function ca(a) {
			...
			if (h == g.length && 0 === b && d == h && "" === a.oScroll.sX && "" === a.oScroll.sY) for (f = 0; f < a.aoColumns.length; f++) c = i(g[f]).width(), null !== c && (a.aoColumns[f].sWidth = q(c));
			else {
				...
				for (f = d = 0; f < h; f++) {
					var j = a.aoColumns[f];
					j.bVisible && null !== j.sWidthOrig && "" !== j.sWidthOrig ? g[f - d].style.width = q(j.sWidthOrig) : j.bVisible ? g[f - d].style.width = "" : d++
				}
		...
		function Q(a, b) {
			...
			if (!a.oFeatures.bServerSide && (0 !== a.aaSorting.length || null !== a.aaSortingFixed)) {
				...
				for (c = 0; c < o.length; c++) if (d = o[c][0], h = t(a, d), f = a.aoColumns[d].sSortDataType, j.ext.afnSortData[f]) if (g = j.ext.afnSortData[f].call(a.oInstance, a, d, h), g.length === r.length) {
					h = 0;
				...
				for (d = r.length; c < d; c++) for (h = 0; h < q; h++) {
					G = l[o[h][0]].aDataSort;
					g = 0;
					for (e = G.length; g < e; g++) f = l[G[g]].sType, f = k[(f ? f : "string") + "-pre"], r[c]._aSortData[G[g]] = f ? f(x(a, c, G[g], "sort")) : x(a, c, G[g], "sort")
				}
		...
		function R(a) {
			var b, c, d, h, f, e = a.aoColumns.length,
				j = a.oClasses;
			...
			if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
				...
				else if (d.length >= e) for (b = 0; b < e; b++) if (-1 != d[b].className.indexOf(f + "1")) {
					c = 0;
		...
		function Ua(a) {
			for (var b = O.location.pathname.split("/"), a = a + "_" + b[b.length - 1].replace(/[\/:]/g, "").toLowerCase() + "=", b = l.cookie.split(";"), c = 0; c < b.length; c++) {
				for (var d = b[c];
		...
		var V = /\[.*?\]$/,
			Ya = O.JSON ? JSON.stringify : function(a) {
				var b = typeof a;
		...
		this.fnGetData = function(a, b) {
			...
			if (a !== n) {
				...
				return b !== n ? x(c, d, b, "") : c.aoData[d] !== n ? c.aoData[d]._aData : null
			}
			return Z(c)
		};
		...
		this.fnSetColumnVis = function(a, b, c) {
			...
			if (g[a].bVisible != b) {
				...
				e = 0;
				for (f = d.aoOpenRows.length; e < f; e++) d.aoOpenRows[e].nTr.colSpan = w(d);
				if (c === n || c) k(d), z(d);
				qa(d)
			}
		};
		...
		this.fnUpdate = function(a, b, c, d, e) {
			...
			} else if (i.isPlainObject(a) && c === n) {
				f.aoData[b]._aData = i.extend(!0, {}, a);
				for (c = 0; c < f.aoColumns.length; c++) this.fnUpdate(x(f, b, c), b, c, !1, !1)
			} else {
				I(f, b, c, a);
				var a = x(f, b, c, "display"),
					g = f.aoColumns[c];
		...
		this.oApi = {
			...
			_fnReDraw: aa,
			_fnAjaxUpdate: xa,
			_fnAjaxParameters: Fa,
			_fnAjaxUpdateDraw: Ga,
			_fnServerParams: ja,
			_fnAddOptionsHtml: ya,
			_fnFeatureHtmlTable: Ca,
			_fnScrollDraw: Ma,
			_fnAdjustColumnSizing: k,
			_fnFeatureHtmlFilter: Aa,
			_fnFilterComplete: M,
			_fnFilterCustom: Ja,
			_fnFilterColumn: Ia,
			_fnFilter: Ha,
			_fnBuildSearchArray: ka,
			_fnBuildSearchRow: ma,
			_fnFilterCreateSearch: la,
			_fnDataToSearch: Ka,
			_fnSort: Q,
			_fnSortAttachListener: ha,
			_fnSortingClasses: R,
			_fnFeatureHtmlPaginate: Ea,
			_fnPageChange: pa,
			_fnFeatureHtmlInfo: Da,
			_fnUpdateInfo: La,
			_fnFeatureHtmlLength: za,
			...
			_fnVisbleColumns: w,
			_fnCalculateEnd: A,
			_fnConvertToWidth: Na,
			_fnCalculateColumnWidths: ca,
			_fnScrollingWidthAdjust: Pa,
			_fnGetWidestNode: Oa,
			_fnGetMaxLenString: Qa,
			_fnStringToCss: q,
			_fnDetectType: D,
			...
			_fnCreateCookie: function(a, b, c, d, e) {
				...
				var c = O.location.pathname.split("/"),
		...
		return this.each(function() {
			...
			0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
			else {
				a = 0;
				...
				if ("" !== g.oScroll.sX || "" !== g.oScroll.sY) g.oScroll.iBarWidth = Ra();
				...
				if (f) for (a = 0; a < e.aaData.length; a++) J(g, e.aaData[a]);
				else va(g);
